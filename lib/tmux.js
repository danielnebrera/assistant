...
// Esc: interrumpe la acción en curso del CLI claude (parada SUAVE, no mata la sesión).
const interrupt = (name) => tmux(['send-keys', '-t', name, 'Escape']);

module.exports = { tmux, exists, panePid, create, kill, capture, sendKeys, sendEnter, interrupt };
